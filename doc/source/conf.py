...
# -*- coding: utf-8 -*-
#
# montypy.meaning documentation build configuration file, created by
...
try:
    fullversion = version("montypy.meaning")
except Exception:
...
modindex_common_prefix = ["montypy.meaning"]
...
basename = "montypy.meaning".replace(" ", "").replace(".", "")
